...
# output stage
loss = fully_connected(pool5_7_7, 5 ,activation='softmax')
network = regression(loss, optimizer='sgd', learning_rate=0.01,
...
model.fit({'input': X}, {'target': Y}, n_epoch=100,
           validation_set=({'input': X_val}, {'target': Y_val}),snapshot_step=100, show_metric=True)

model.save('project2_c.tflearn')
model.load('project2_c.tflearn')
predictions = model.predict_label(X_test)
new_y = np.argmax(predictions, axis=1)
np.savetxt('project2_20404460_report.txt',new_y,fmt="%d",newline='\n')
...
>>>>>>> parent of 298ead8... update project 2
